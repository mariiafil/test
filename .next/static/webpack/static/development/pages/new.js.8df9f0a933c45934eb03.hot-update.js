        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (title.trim().length > 0 && body.trim().length > 0) {
              // onAddPost(dispatch => dispatch({ title, body }));
              onAddPost(function () {
                return dispatch({
                  title: title,
                  body: body
...
var mapDispatchToProps = {
  onAddPost: _redux_store__WEBPACK_IMPORTED_MODULE_4__["addPost"]
}; // export default NewPost;

/* harmony default export */ __webpack_exports__["default"] = (Object(_redux_store__WEBPACK_IMPORTED_MODULE_4__["nextConnect"])(function (state) {
  return state;
})(NewPost));
...
//# sourceMappingURL=new.js.8df9f0a933c45934eb03.hot-update.js.map